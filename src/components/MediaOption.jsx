const MediaOption = ({openMediaOption}) => {
  return (
    <div className={`z-10 absolute bottom-16 w-[10%] h-[30%] p-1.5 overflow-hidden ${openMediaOption ? 'block' : 'hidden'}`}>
    {/* <div
  className="absolute w-5 bottom-0 pointer-events-auto"
            ...
            <g>
              ...
              <g clipPath="url(#camera-SVGID_2_)">
                ...
                <path
                  ...
                  d="M53,26.5H-1.1c0,14.6,13,27.6,27.6,27.6s27.6-13,27.6-27.6C54.1,26.5,53,26.5,53,26.5z"
                />
                <rect x={17} y="24.5" fill="#D3396D" width={15} height={9} />
              </g>
            </g>
            <g fill="#F5F5F5">
              <path

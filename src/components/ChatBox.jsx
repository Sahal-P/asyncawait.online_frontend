...
const ChatBox = ({ NetworkOnline }) => {
  ...
  // };
    ...
    const  {socket, chatWSConnected, send_message}  = useChatWebSocket(NetworkOnline)
  ...
  //   return () => {
  //     if (_socket) {
  //       _socket.removeEventListener("message", connectWebSocket.handleSocketMessage);
  //       _socket.removeEventListener("open", connectWebSocket.handleSocketOpen);
  //     _socket.removeEventListener("error", connectWebSocket.handleSocketError);
